...
const RULES_MAP = {
  ...
  "www.youtube.com": {
    ...
    ignoreSelector: `aside, button, footer, form, header, pre, mark, nav, #player, #container, .caption-window, .ytp-settings-menu, #lingoflow-youtube-subtitle-list-container`,
    selectStyle: `-webkit-line-clamp: unset; max-height: none; height: auto;`,
